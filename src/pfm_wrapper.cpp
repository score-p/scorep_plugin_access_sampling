...
bool
PfmWrapper::is_metric_supported (const std::string& metric_name)
{
    int ret = -1;
    try
    {
...
void
PfmWrapper::get_perf_event (const std::string& metric_name, uint64_t sample_period, PerfEventAttribute* perf_attr)
{
